...
public class WorldIT
{
    ...
    @Test
    void testTheTopNPopulatedCountriesInTheWorldWhereNIsProvidedByTheUser() {
        List<Country> countries = reports.TheTopNPopulatedCountriesInTheWorldWhereNIsProvidedByTheUser(5);
        assertEquals(5, countries.size(), "The total number of countries should be 5.");
    ...
    @Test
    void testAllTheCitiesInTheWorldOrganisedByLargestPopulationToSmallest(){
        List<City> cities = reports.AllTheCitiesInTheWorldOrganisedByLargestPopulationToSmallest();
        assertEquals(4079, cities.size(), "The total number of Cities should be 4,079.");
    ...
    @Test
    void testAllTheCitiesInAContinentWhereNIsProvidedByTheUser() {
        List<City> cities = reports.AllTheCitiesInAContinentOrganisedByLargestPopulationToSmallest("Asia");
        assertEquals(1766, cities.size(), "The total number of Cities should be 5.");
